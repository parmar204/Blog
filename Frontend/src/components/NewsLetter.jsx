  ...
  return (
    <div className='flex flex-col items-center justify-center text-center space-y-2 my-32'>
        ...
        <form className='flex items-center justify-between max-w-2xl w-full md:h-13 h-12'>
            ...
            <button type='submit' className='cursor-pointer h-full text-white bg-primary/80 hover:bg-primary transition-all rounded-md rounded-l-none px-8 md:px-12'>Subscribe</button>
        </form>
    </div>
  )
}
